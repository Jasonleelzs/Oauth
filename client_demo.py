...
@app.route('/')
def index():
    return render_template('client_index.html', config=oauth_config)
...
def oauth_redirect():
    ...
    apply_token_url = 'http://localhost:3000/oauth/access_token?client_id={}&client_secret={}&code={}'.format(oauth_config['client_id'],
    ...
    return render_template('client_redirect.html', github=github_messages)
